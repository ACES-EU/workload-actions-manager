...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WAMArgs) DeepCopyInto(out *WAMArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.Test != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WAMArgs.
func (in *WAMArgs) DeepCopy() *WAMArgs {
	if in == nil {
		return nil
	}
	out := new(WAMArgs)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *WAMArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil

...
func RegisterDefaults(scheme *runtime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&WAMArgs{}, func(obj interface{}) { SetObjectDefaults_WAMArgs(obj.(*WAMArgs)) })
	return nil
}
...
func SetObjectDefaults_WAMArgs(in *WAMArgs) {
	SetDefaults_WAMArgs(in)
}
